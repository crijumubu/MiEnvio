...
class promedioVelocidadModel {
    constructor() {
        this.obtenerVelocidades = (fn) => __awaiter(this, void 0, void 0, function* () {
            this.mongo.connect();
            const rows = yield this.mongo.model.find();
            fn(rows);
        });
        this.idVelocidad = (id, fn) => __awaiter(this, void 0, void 0, function* () {
            this.mongo.connect();
            const rows = yield this.mongo.model.find({ idVelocidad: id });
            fn(rows);
        });

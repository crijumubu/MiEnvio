...
import 'package:frontend/views/flete_form/widgets/date_picker.dart';
                ...
                Form(
                  child: Column(
                    children:  [
                      ...
                      Row(
                        children: [
                          Input(controller: horaCargue, inputText: "¿Horas acordadas para el cargue?", width: width*0.42,),
                          const Spacer(),
                          Input(controller: horaCargue, inputText: "¿Horas acordadas para el descargue?", width: width*0.42,),
                        ],
                      ),
                      SizedBox(height: height*0.025,),
                      Row(
